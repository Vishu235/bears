...
Beyond the evaluation mode, the paper also tests various *training-time* mitigations that can be combined:
...
The key comparison BEARS makes: it achieves RS-awareness comparable to CSUP *without any concept labels*.
